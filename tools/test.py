...
def parse_config():
    ...
    parser.add_argument('--roihead_only', required=False, default=False, help='only train roi head, added by zrx')
...
def main():
    ...
    TRAIN_ROI_ONLY=args.roihead_only
    global_var._init()
    global_var.set_value('TRAIN_ROI_ONLY', TRAIN_ROI_ONLY)
