...
class NuScenesDataset(DatasetTemplate):
    ...
    def kitti_eval(self, eval_det_annos, eval_gt_annos, class_names):
        from ..kitti.kitti_object_eval_python import eval_latest as kitti_eval
...
# rename as nusc_eval
    def nusc_eval(self, det_annos, class_names, **kwargs):
        import json
    ...
    def evaluation(self, det_annos, class_names, **kwargs):
        if kwargs['eval_metric'] == 'kitti':
            ...
            return self.nusc_eval(det_annos, class_names, **kwargs)
        else:
